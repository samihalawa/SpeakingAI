...
export function ChatInterface() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      ...
      <div className="sticky bottom-0 w-full bg-background border-t z-[9999] shadow-lg">
        <form onSubmit={handleSubmit} className="px-4 py-3 sm:py-4 md:pb-6 flex gap-2 max-w-2xl mx-auto items-center">
          <Input 
            placeholder="输入消息..."
            value={input}
